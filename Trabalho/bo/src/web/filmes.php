    ...
    <div class="content-wrapper">
      <div class="row">
       <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Filmes</h4><a href='#addMovie' class="btn btn-success"  data-toggle='modal'><i class='mdi mdi-plus-circle  '  title='Add'></i></a>
              ...
              $sql = "SELECT * FROM filmes";
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    ...
                    <td> <a href='#editfilme<?php echo $row['id']; ?>' class="btn btn-warning"  data-toggle='modal'><i class='mdi mdi-account-edit  '  title='Edit'></i></a>
                ...
                <script>
                  function deleteme(delid) {
                    if (confirm("Tem a certeza que quer eliminar?")) {
                     window.location.href='del_filme.php?delid='+delid+'';
                     return true;
                   }
                 }
               </script>   
